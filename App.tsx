...
const App: React.FC = () => {
  ...
  const saveHighScore = useCallback((name: string, finalScore: number) => {
  ...
  const renderContent = () => {
    switch (gameState) {
      ...
      case GameState.GameOver:
        return <GameOverScreen score={score} highScores={highScores} onSave={saveHighScore} />;
